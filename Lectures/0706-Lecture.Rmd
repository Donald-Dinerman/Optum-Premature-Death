...
image_read("https://bradleyboehmke.github.io/HOML/15-pca_files/figure-html/create-pca-image-1.png") %>% print()
```
...
pca_nfl <- prcomp(model_x, center = TRUE, scale = TRUES) #<<
...
```{r, fig.align='center', fig.height=5}
fviz_pca_biplot(pca_nfl, label = "var", alpha.ind = 0.5, col.var = "darkblue", alpha.var = 0.75)
```
