...
library(magick)
image_read("https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Gamma_distribution_pdf.svg/650px-Gamma_distribution_pdf.svg.png") %>% print()
```
...
```{r out.width='50%', echo = FALSE, fig.align='center'}
image_read("https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Beta_distribution_pdf.svg/650px-Beta_distribution_pdf.svg.png") %>% print()
```
...
```{r out.width='50%', echo = FALSE, fig.align='center'}
image_read("https://upload.wikimedia.org/wikipedia/commons/thumb/7/74/Bernoulli_Distribution.PNG/650px-Bernoulli_Distribution.PNG") %>% print()
```
