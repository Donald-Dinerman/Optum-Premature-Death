...
Uses the weights PCA applies to p predictors (loadings/phi) to transform the predictors. Then performs a regression function on these transformed predictors to the response variable.

```{r out.width='50%', echo = FALSE, fig.align='center'}
library(magick)

image_read("https://bradleyboehmke.github.io/HOML/images/pcr-steps.png") %>% print()
```
...
cv_model_pcr <- train(
  ...
  tuneLength = ncol(nfl_model_data) - 1) #number of predictors
...
image_read("https://bradleyboehmke.github.io/HOML/images/pls-vs-pcr.png") %>% print()
```
...
#cv_model_pls$finalModel$loadings
```
