...
library(tidyverse)
library(magick)
image_read("http://www.stat.cmu.edu/~pfreeman/data_geometry.png") %>% print()
```
...
image_read("https://bradleyboehmke.github.io/HOML/images/decision-tree-terminology.png") %>% print()
```
...
```{r out.width='100%', echo = FALSE, fig.align='center'}
image_read("https://bradleyboehmke.github.io/HOML/images/exemplar-decision-tree.png") %>% print()
```
...
image_read("https://bradleyboehmke.github.io/HOML/07-decision-trees_files/figure-html/dt-early-stopping-1.png") %>% print()
```
...
image_read("https://bradleyboehmke.github.io/HOML/07-decision-trees_files/figure-html/pruned-tree-1.png") %>% print()
```
...
init_mlb_tree #LOSS: MSE for regression, GINI Impurity for Classification
```
...
library(rpart.plot)
rpart.plot(init_mlb_tree) #leaves and nodes represent avg response value and the % of data within them
```
