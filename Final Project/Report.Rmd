...
p1 = plot(sm(viz_gam, 1)) + l_fitLine(colour = "red") + 
  l_rug(mapping = aes(x=x, y=y), alpha = 0.5) +
  l_ciLine(mul = 5, colour = "blue", linetype = 2) + 
  l_points(shape = 19, size = 1, alpha = 0.05) + 
  theme_classic() +
  labs(x = "Inactivity", y = "s(Inactivity)")
...
p3 = plot(sm(viz_gam, 3)) + l_fitLine(colour = "red") + 
  ...
  l_points(shape = 19, size = 1, alpha = 0.05) + 
  theme_classic() +
  labs(x = "Healthy Food Access", y = "s(Healthy Food Access)")
...
- Our simplified GAM performs equally to XGBoost but provides a more explainable modeling approach.
