...
p2 = plot(sm(viz_gam, 2)) + l_fitLine(colour = "red") + 
  ...
  l_points(shape = 19, size = 1, alpha = 0.05) + 
  theme_classic() +
  labs(x = "Obesity", y = "Predicted YPLL")
...
p3 = plot(sm(viz_gam, 3)) + l_fitLine(colour = "red") + 
  ...
  l_points(shape = 19, size = 1, alpha = 0.05) + 
  theme_classic() +
  labs(x = "Lack Healthy Food Access", y = "Predicted YPLL")
...
p4 = plot(sm(viz_gam, 4)) + l_fitLine(colour = "red") + 
  ...
  l_points(shape = 19, size = 1, alpha = 0.05) + 
  theme_classic() +
  labs(x = "Drinking", y = "Predicted YPLL")
...
GAMs are transparent, interpretable, and flexible models that are sure to outperform the linear regression because it could capture both linear and nonlinear relationships with splines. Furthermore, there are built in regularization penalties on the smooth functions to reduce overfitting. 
...
For instance, (describe a couple PDPs)
