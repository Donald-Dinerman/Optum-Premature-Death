---
title: "Report: Predicting Premature Deaths"
...
ypll_drink = ggplot(county_pred_df, aes(y = YPLL, x = drink_per)) +
  ...
  theme_bw() +
  geom_smooth(se = F) +
  labs(title = "YPLL Decreases As Smoking Prevelance Increases", y = "Years of Potential Life Lost (YPLL)", x = "% Excessive Drinking")

ypll_food = ggplot(county_pred_df, aes(y = YPLL, x = food_per)) +
  geom_point(alpha = 0.25) +
  theme_bw() +
  geom_smooth(se = F) +
  labs(title = "YPLL Increases As Food Insecurity Increases", y = "Years of Potential Life Lost (YPLL)", x = "% Food Insecure")

ypll_obesity = ggplot(county_pred_df, aes(y = YPLL, x = obesity_rate)) +
  geom_point(alpha = 0.25) +
  theme_bw() +
  geom_smooth(se = F) +
  labs(title = "YPLL Increases As Obesity Levels Increases", y = "Years of Potential Life Lost (YPLL)", x = "% Adults with Obesity")
...
ypll_countyclass = ggplot(county_pred_df, aes(y = YPLL, x = county_class)) +
  ...
  theme_bw() +
  labs(title = "YPLL Variability Increase as County Population Decreases", y = "Years of Potential Life Lost (YPLL)", x = "County Type")
```
...
food_obesity = ggplot(county_pred_df, aes(y = food_per, x = obesity_rate)) +
  ...
  geom_smooth(se = F) +
  theme_bw() +
  labs(title = "Positive Relationship Between Obesity and Food Insecurity", y = "% Food Insecure", x = "% Adults with Obesity")

food_drink = ggplot(county_pred_df, aes(y = food_per, x = drink_per)) +
  geom_point() +
  geom_smooth(se = F) +
  theme_bw() +
  labs(title = "Inverse Relationship Between Food Insecurity and Excessive Drinking", y = "% Food Insecure", x = "% Excessive Drinking")

smoke_dui = ggplot(county_pred_df, aes(y = smoke, x = dui_per)) +
  geom_point() +
  geom_smooth(se = F) +
  theme_bw() +
  labs(title = "No Relationship Between Smoking and Alcohol Driving Deaths", y = "% Smokers", 
       x = "% Driving Deaths with Alcohol Involvement")
```
...
```{r}
#Predictors vs Predictors (food/drink)
food_drink
```

```{r}
#Predictors vs Predictors (smoke/dui)
smoke_dui
```
