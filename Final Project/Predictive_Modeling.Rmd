...
xgb_tune <- train(x = as.matrix(dplyr::select(xg_df, -c(YPLL, Population, test_fold, county_class))),
...
xgb_fit_final <- xgboost(data = as.matrix(dplyr::select(xg_df, -c(YPLL, Population, test_fold, county_class))),
