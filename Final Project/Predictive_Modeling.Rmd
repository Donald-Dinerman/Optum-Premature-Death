...
simple_model = lm(YPLL ~ std + smoke, data = state_tobacco_sex_df)
...
```{r}
#County
county_simple_model = lm(YPLL ~ std + smoke, data = county_tobacco_sex_df)
county_simple_model = lm(YPLL ~ std + smoke*county_class, data = county_tobacco_sex_df)
county_simple_model = lm(YPLL ~ std + smoke + log(Population), data = county_tobacco_sex_df)
