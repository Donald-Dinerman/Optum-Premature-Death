...
#### HELP: Add mixed effects model (why is it the same as lm), explore/discuss CV results, discuss alternative linear modeling approaches, should I explore alternative tree based approaches
```{r}
#stratified k fold
set.seed(1)
