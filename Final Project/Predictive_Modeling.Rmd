...
ypll_hist = function(pred_value){
  ...
  ggplot(county_response_df, aes(x = all_YPLL)) +
    ...
    theme_bw() +
    labs(x = "YPPL", y = "Count", title = "Predicted YPLL Percentile Ranking")
}
...
# Tooltip not working, may be some interaction issues with the theme
# Make plot 1 title a h4 header element, reduce width of plots bc browser view is zoomed in, apply browser title (prob in navbarpage)
# Shiny App
