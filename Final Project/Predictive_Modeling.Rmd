...
demo_map = function(df = demo_response_clean_df, Race_Type, limit_set = c(), region = c()) {
  ...
  plot_usmap(data = filter(df, Race == filter_input), values = "YPLL", color = "black", include = region) + 
...
demo_map(Race_Type = "Asian", region = 'Alaska')
...
ui = navbarPage(title = div(img(
  ...
  src = "https://512solutions.com/wp-content/uploads/2021/04/Optum-logo.png", height = 55, width = 190), ""),
      ...
      tabPanel(title = "Predictive Modeling",
          ...
          tags$head(
           tags$style(HTML('.dx-tabpanel .dx-tab {height: 70px;}'))
         ),
    ...
    tabPanel(title = "Premature Deaths Map",
